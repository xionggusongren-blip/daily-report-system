...
営業担当者のメモから訪問先と同行者を抽出し、詳細な商談内容を整理してJSONで出力してください。

【最重要ルール - 訪問先の区切り方】
★ 1行 = 1訪問先 です
★ 改行で区切られている場合のみ、別の訪問先として扱います
★ 1行の中に複数の会社名が出てきても、それは1つの訪問記録です
★ 商談内容の中で言及される他社（メーカー名、仕入先名、競合名など）は訪問先ではありません

【入力形式の例】
入力が改行で区切られている場合 → 複数の訪問先
\`\`\`
滝沢電機　新規ヒアリング
アジア電気　定期訪問
\`\`\`
...
【商談内容（memo）の書き方】
★ その行に書かれた情報をすべて文章化して含める
★ 具体的な数字、製品名、担当者名、課題、今後の予定などがあれば必ず含める
★ 「〜しました。」「〜の予定です。」「〜とのことです。」のように敬体で書く
★ メモにない事実は追加しない

【出力例1】複数行入力 → 複数訪問
入力:
「滝沢電機　新規ヒアリング　コンデンサ見積依頼
アジア電気　定期訪問　リピート受注」
出力: {"extracted_visits":[{"company_name":"滝沢電機","memo":"新規案件のヒアリングを実施しました。コンデンサの見積依頼をいただきました。","companions":[]},{"company_name":"アジア電気","memo":"定期訪問を行いました。リピート受注となりました。","companions":[]}]}

【出力例2】1行入力（他社名含む） → 1訪問
入力:
「ミスミ訪問　岡村部長と同行　村田製作所・TDKのコンデンサ提案　サトーパーツは非在庫から」
出力: {"extracted_visits":[{"company_name":"ミスミ","memo":"岡村部長と同行で訪問しました。村田製作所とTDKのコンデンサを提案しました。サトーパーツについては非在庫製品からのスタートとなります。","companions":["岡村"]}]}

【重要】
- 必ずJSON形式のみを出力（説明文は不要）
- 1行 = 1訪問先を厳守
- 会社名が見つからない場合は {"extracted_visits":[]} を出力`;
